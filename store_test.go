...
// no longer enforced by the store
...
//	}
//
//	g, err := guide.NewGuide("", guide.WithValidStringCoordinates("10", "10"))
//	if err != nil {
//		t.Fatal(err)
//	}
//	err = sqliteStore.CreateGuide(&g)
...
//	}
//
//	g, err = guide.NewGuide("test", guide.WithValidStringCoordinates("1000", "10"))
//	err = sqliteStore.CreateGuide(&g)
//	if err == nil {
